...
namespace Apps\Fintech\Packages\Etf\Investments\Install;

use Apps\Fintech\Packages\Etf\Investments\Install\Schema\EtfInvestments;
...
class Install extends BasePackage
{
    ...
    public function init()
    {
        $this->databases =
            [
                'apps_fintech_etf_investments'  => [
                    'schema'        => new EtfInvestments,
                    'model'         => new AppsFintechEtfInvestments
                ]
            ];
